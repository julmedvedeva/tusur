...
# Файлы листингов для Приложения А (заголовок раздела -> путь к файлу)
LISTINGS = {
    "А.1": "task_6_3.py",
    "А.2": "task_6_4.py",
    "А.3": "task_6_5.py",
