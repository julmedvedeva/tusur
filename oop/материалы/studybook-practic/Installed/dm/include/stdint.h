...
#define INTMAX_C(v)	__EXPAND(v)##LL
#define UINTMAX_C(v)	__EXPAND(v)##ULL
#else
#define INTMAX_MIN	(-2147483647L - 1)
#define INTMAX_MAX	2147483647
#define UINTMAX_MAX	4294967295
#define INTMAX_C(v)	__EXPAND(v)##L
#define UINTMAX_C(v)	__EXPAND(v)##UL
#endif
...
#define INT16_C(v)	v
#define UINT16_C(v)	v
#define INT32_C(v)	__EXPAND(v)##L
#define UINT32_C(v)	__EXPAND(v)##UL

#if __LONGLONG
#define INT64_C(v)	__EXPAND(v)##LL
#define UINT64_C(v)	__EXPAND(v)##ULL
#endif
