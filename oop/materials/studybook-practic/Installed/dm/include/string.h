...
extern "C++" {
inline const char *strchr(const char *s, int n) { return strchr((char *)s, n); }
inline const char *strrchr(const char *s, int n) { return strrchr((char *)s, n); }
inline const char *strpbrk(const char *s1,const char *s2) { return (char *) strpbrk((char *)s1,s2); }
inline const char *strstr(const char *s1,const char *s2) { return strstr((char *)s1, s2); }
inline const void *memchr(const void *s, int c, size_t n) { return memchr((void *)s, c, n); }
