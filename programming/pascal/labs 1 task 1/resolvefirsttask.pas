...
var
  ...
  closestValue, diff, currentNumber: real; // x - текущее число, closestValue - текущее минимальное значение разности, diff - разность для текущего числа, currentNumber - число, вводимое пользователем
