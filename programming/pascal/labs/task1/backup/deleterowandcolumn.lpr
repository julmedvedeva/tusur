...
type
  BoolArray6x6 = array [1..SIZE, 1..SIZE] of boolean;
  BoolArray5x5 = array [1..SIZE-1, 1..SIZE-1] of boolean;
...
begin
  ...
  begin
    for j := 1 to SIZE-1 do
      write(ord(B[i, j]), ' '); // Преобразование логического значения в целое число и вывод
    writeln;
  end;
end.
